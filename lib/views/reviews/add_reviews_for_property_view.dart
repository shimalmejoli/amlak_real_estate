...
import 'package:amlak_real_estate/controller/add_reviews_for_property_controller.dart';
import 'package:amlak_real_estate/gen/assets.gen.dart';

class AddReviewsForPropertyView extends StatelessWidget {
  AddReviewsForPropertyView({super.key});

  final AddReviewsForPropertyController addReviewsForPropertyController =
      Get.put(AddReviewsForPropertyController());
