// lib/views/agents_list/agents_list_view.dart
...
import 'package:amlak_real_estate/controller/agents_list_controller.dart';
...
class AgentsListView extends StatelessWidget {
  AgentsListView({Key? key}) : super(key: key);

  final AgentsListController c = Get.put(AgentsListController());
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return ListView.builder(
          ...
          itemCount: c.agents.length,
          itemBuilder: (context, index) => _agentTile(c.agents[index]),
        );
      }),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(
              ...
              height: AppSize.appSizePoint7, // no extra vertical space
            ),

            // small spacing below divider
            const SizedBox(height: AppSize.appSize8),

            // Email + Property Count (with larger icon)
            Row(
              children: [
                Icon(Icons.email,
