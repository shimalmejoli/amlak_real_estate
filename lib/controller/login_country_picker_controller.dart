// lib/controller/login_country_picker_controller.dart
...
class LoginCountryPickerController extends GetxController {
  /// Search field in the bottom sheet
  final TextEditingController searchController = TextEditingController();

  /// The index of the currently-selected country
  final RxInt selectedIndex = 0.obs;

  /// List of flag image asset paths
  final RxList<String> flagsImageList = <String>[
  ...
  /// List of country name/code maps
  final RxList<Map<String, String>> countries = <Map<String, String>>[
    {
    ...
    },
    {
      ...
      AppString.codeText: AppString.indiaCode,
    },
    {
    ...
    {
      AppString.namePicker: AppString.iraq, // ← Iraq
      AppString.codeText: AppString.iraqCode, // ← +964
    },
    {
  ...
  void onInit() {
    super.onInit();
    // Default the picker to Iraq
    final idx =
        countries.indexWhere((c) => c[AppString.namePicker] == AppString.iraq);
    if (idx != -1) {
      selectedIndex.value = idx;
    }
  }

  /// Update the selection when a country is tapped
